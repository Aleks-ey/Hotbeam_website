    ...
    <div className="instagram_header_div">
        <div className='instagram_header'>
            ...
            <div className="instagram_profile_info">
                <h1>Hot Beam Productions</h1>
                <div className="counts">
                    <div className="count"><span>10</span> posts</div>
                    <div className="count"><span>100</span> followers</div>
                    <div className="count"><span>50</span> following</div>
                </div>
            </div>
